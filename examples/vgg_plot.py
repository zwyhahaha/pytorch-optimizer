...
colorblindbright = [(252,145,100),(188,56,119),(114,27,166),(37,52,148),(8,104,172),]
colorblindbright = [
    (0, 114, 178),  # Blue
    (213, 94, 0),   # Vermilion
...
colorblinddim    = [(213,167,103),(163,85,114),(104,59,130),(53,88,153),(2,134,180),(1,108,89)]
...
colors = {'sgd':colorblindbright[0], 'sgdn':colorblindbright[1],'adam':colorblindbright[2], \
          'sgd_hd':colorblindbright[0], 'sgdn_hd':colorblindbright[1],'adam_hd':colorblindbright[2],\
            'osgm':colorblindbright[3], 'osmm':colorblindbright[4]}
