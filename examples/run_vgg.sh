...
# python examples/vgg_train.py --cuda --device 2 --model mlp --method adam    --save --epochs 100 --alpha_0 0.00001 --beta 1e-7 --parallel --silent & 


python examples/vgg_train.py --cuda --device 3 --model logreg --method osmm --save --epochs 10 --alpha_0 0.01 --beta_lr 0.1 --beta 0.995 --silent &
wait